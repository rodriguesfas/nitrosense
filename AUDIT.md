...
| Per-core CPU | `/proc/stat` cpuN + sparkline grid | **RESOURCES** |
...
| Backlight timeout | sysfs | **yes; LIGHTING** |
| Display brightness + Night Light | GNOME session | **LIGHTING** |
...
| RTX TGP Default / Boost | `nvidia-smi -pl` via pkexec helper | **SETTINGS** |
